...
//         const insertReport = `
//             INSERT INTO REPORT (Proof, End_date, taskId, task_taker_id) 
//             VALUES ($1, $2, $3, $4)
//         `;

//         await client.query(insertReport, [Agreement, End_date, taskId, task_taker_id]);

//         return res.status(200).json({ message: 'report inserted', status: true });
//     } catch (error) {
//         console.log('internal report server error :', error.message);
//         return res.status(500).json({ error: 'internal server report error' });
//     } finally {
//         client.release();
//     }
// };
